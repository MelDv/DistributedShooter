...
namespace TerrainComposer2
{
    public class TCProducts
    {
        ...
        void DrawMCS(ref Rect rect, float width, float alpha)
        {
            ...
            {
                Application.OpenURL("https://assetstore.unity.com/packages/tools/modeling/mesh-combine-studio-2-101956?aid=1011le9dK&pubref=uTC_MCS");
            }
            if (mcsSale)
            {
        ...
        void DrawMCSCaves(ref Rect rect, float width, float alpha)
        {
            ...
            {
                Application.OpenURL("https://assetstore.unity.com/packages/tools/terrain/mcs-caves-overhangs-144413?aid=1011le9dK&pubref=uTC_MCSCaves");
            }
            if (mcsCavesSale)
            {
                GUI.DrawTexture(new Rect(rect.x + 10, rect.y + 20, rect.width - 20, (rect.width - 20) * 0.37068f), saleIcon);
        ...
        void DrawDE(ref Rect rect, float width, float alpha)
        {
            ...
            {
                Application.OpenURL("https://assetstore.unity.com/packages/tools/utilities/debugging-essentials-170773?aid=1011le9dK&pubref=uTC_DE");
            }
            if (deSale)
            {
        ...
        void DrawTC(ref Rect rect, float width, float alpha)
        {
            ...
            {
                Application.OpenURL("https://assetstore.unity.com/packages/tools/terrain/terrain-composer-2-65563?aid=1011le9dK&pubref=uTC_TC");
            }
            if (tcSale)
            {
