...
namespace TerrainComposer2
{
	...
	public class TC_Generate : MonoBehaviour
	{
		...
		public static event EventMethod onPreStartGenerateHeight;
		public static event EventMethod onPreStartGenerateSplat;
		public static event EventMethod onPreStartGenerateColor;
		public static event EventMethod onPreStartGenerateTrees;
		public static event EventMethod onPreStartGenerateGrass;
		public static event EventMethod onPreStartGenerateObjects;
		...
		public static void AddEvent(TC_ItemBehaviour node, EventMethod eventMethod)
        {
			if (node.outputId == TC.heightOutput) onPreStartGenerateHeight += eventMethod;
			else if (node.outputId == TC.splatOutput) onPreStartGenerateSplat += eventMethod;
			else if (node.outputId == TC.colorOutput) onPreStartGenerateColor += eventMethod;
			else if (node.outputId == TC.grassOutput) onPreStartGenerateGrass += eventMethod;
			else if (node.outputId == TC.treeOutput) onPreStartGenerateTrees += eventMethod;
			else if (node.outputId == TC.objectOutput) onPreStartGenerateObjects += eventMethod;
		}

		public static void RemoveEvent(TC_ItemBehaviour node, EventMethod eventMethod)
		{
			if (node.outputId == TC.heightOutput) onPreStartGenerateHeight -= eventMethod;
			else if (node.outputId == TC.splatOutput) onPreStartGenerateSplat -= eventMethod;
			else if (node.outputId == TC.colorOutput) onPreStartGenerateColor -= eventMethod;
		...
		public void Generate(bool instantGenerate, Rect generateRect, int outputId = TC.allOutput)
		{
			...
			if (area2D == null) return;
			if (area2D.terrainLayer == null) return;
			if (area2D.terrainLayer.layerGroups[0] == null) area2D.terrainLayer.GetItems(true);
			...
			for (int i = 0; i < terrainArea.terrains.Count; i++)
			{
                ...
                if (tcTerrain.texHeight == null || (scanHeight && !area2D.terrainLayer.layerGroups[TC.heightOutput].active))
                {
		...
		public void ExportHeightmap(string path)
		{
			...
			int i = 0;
			int offset = TC_Area2D.instance.resExpandBorder;
        ...
        public void ComputeHeight(Rect generateRect)
		{
			...
			if (onPreStartGenerateHeight != null) onPreStartGenerateHeight();
		...
		public void ComputeColor()
		{
			...
			if (onPreStartGenerateColor != null) onPreStartGenerateColor();
...
//                }
		...
		public void ComputeSplat(Rect generateRect)
		{
			...
			if (onPreStartGenerateSplat != null) onPreStartGenerateSplat();
		...
		public void ComputeGrass()
		{
			...
			if (onPreStartGenerateGrass != null) onPreStartGenerateGrass();
		...
		public void ComputeTree()
		{
			...
			if (onPreStartGenerateTrees != null) onPreStartGenerateTrees();
			...
			List<TC_SelectItem> treeItems = TC_Area2D.instance.terrainLayer.treeSelectItems;
		...
		public void ComputeObject()
		{
			...
			if (onPreStartGenerateObjects != null) onPreStartGenerateObjects();
			...
			List<TC_SelectItem> objectItems = TC_Area2D.instance.terrainLayer.objectSelectItems;
