...
namespace TerrainComposer2
{
    ...
    public class TC_ItemBehaviourEditor : Editor {
        ...
        // SpawnObject
        SerializedProperty spawnObject, linkToPrefab, go, goLayer, rotRangeX, rotRangeY, rotRangeZ, isSnapRot, isSnapRotX, isSnapRotY, isSnapRotZ, snapRotX, snapRotY, snapRotZ, lookAtTarget, lookAtX, heightRange;
        ...
        void OnEnable()
        {
            ...
            else if (selectItem != null)
            {
                ...
                else if (selectItem.outputId == TC.objectOutput)
                {
                    ...
                    goLayer = spawnObject.FindPropertyRelative("goLayer");
        ...
        void OnSceneGUI()
        {
            ...
            if (selectItem != null)
            {
                if (selectItem.parentItem == null) return;
        ...
        {
            return TC.GetApplicationPath() + GetPresetPathFile();
        }
        ...
        void DrawObjectSelectItem()
        {
            ...
            GUI.changed = false;
            goLayer.intValue = EditorGUILayout.LayerField(new GUIContent("Layer"), goLayer.intValue);
